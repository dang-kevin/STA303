...
[^1]: Nodal Involvement, by Predictor
[^2]: Binary Logistic Regression Model 1
[^3]: Binary Logistic Regression Model 2
[^4]: Binary Logistic Regression Model 2, Analysis of Deviance Table
...
```{r nodal-3, message=FALSE, warning=FALSE}
...
### Correlation Matrix
```{r, nodal-4, message=FALSE, warning=FALSE}
